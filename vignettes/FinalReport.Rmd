...
```{r, echo = FALSE}
Parameters <- c("user", "password", "host", "port", "dbname")
Defaults <- c("postgres", "gisde2018", "localhost", "5432", "dbname")
...
Improvements - add option for user to draw extent polygon as input, add highlight to poly to show which is displayed in dashboard, figure out a workaround to remove dependency on setting up a db exactly like ours (set up server to host as web service)
