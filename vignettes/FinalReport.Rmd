...
Packages Section `DOL:MsessionInfo`
...
1.  many package dependencies (are these absolutely necessary?)

2.  users must currently have a postgreSQL/PostGIS db set up exactly like ours for the app to run 

3.  rendering large polys takes a long(er) time to run (re: see sandy path shapefile)
...
1.  add option for user to draw extent polygon as input
