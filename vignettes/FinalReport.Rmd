...
7.  `viridis`
    ...
    The [veridis](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html) package allows access to a wide range of color scales for plotting and graphics purposes. In this project, the default "viridis" palette was used to symbolize census tract polygons. 

8.  stringr
9.  dplyr
10. `DT`

    The [DT](https://rstudio.github.io/DT/) (or Data-Table) package provides a means of rendering and customize an interactive data-table. In this project, the DT package was used to render two data-tables in the "Data Table" tab.
