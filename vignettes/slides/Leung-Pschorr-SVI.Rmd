...
3. Currently the authoritative source on SVI within the US
    
4. Multiple versions of the index
    + 2000, 2010, and 2014
...
2. Informs each stage of the Disaster Management Cycle

3. State and nationwide scales may obscure local variations in social vulnerability

4. Unnecessary (and inaccurate) to look at state/nationwide SVI rankings for an event affecting a specific region
    + E.g. if an event impacts CA, SVI from VT should not affect CA SVI rankings 

5. We aim to create a Shiny web application to calculate SVI on the fly using a user-defined AOI
