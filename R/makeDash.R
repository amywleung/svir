makeDash <- function(shp, rpl, uid) {
  ...
  t1vals <-
    c(dat[["epl_pov"]][(dat$gid == uid) &
                         (!dat[[rpl]] == -999)], dat[["epl_unemp"]][(dat$gid == uid) &
                                                                      (!dat[[rpl]] == -999)],
      dat[["epl_pci"]][(dat$gid == uid) &
                         (!dat[[rpl]] == -999)], dat[["epl_nohsdp"]][(dat$gid == uid) &
                                                                       (!dat[[rpl]] == -999)])
  t2vals <-
    c(dat[["epl_age65"]][(dat$gid == uid) &
                           (!dat[[rpl]] == -999)], dat[["epl_age17"]][(dat$gid == uid) &
                                                                        (!dat[[rpl]] == -999)],
      dat[["epl_disabl"]][(dat$gid == uid) &
                            (!dat[[rpl]] == -999)], dat[["epl_sngpnt"]][(dat$gid == uid) &
                                                                          (!dat[[rpl]] == -999)])
  t3vals <-
    c(dat[["epl_minrty"]][(dat$gid == uid) &
                            (!dat[[rpl]] == -999)], dat[["epl_limeng"]][(dat$gid == uid) &
                                                                          (!dat[[rpl]] == -999)])
  t4vals <-
    c(dat[["epl_munit"]][(dat$gid == uid) &
                           (!dat[[rpl]] == -999)], dat[["epl_mobile"]][(dat$gid == uid) &
                                                                         (!dat[[rpl]] == -999)],
      dat[["epl_crowd"]][(dat$gid == uid) &
                           (!dat[[rpl]] == -999)], dat[["epl_noveh"]][(dat$gid == uid) &
                                                                        (!dat[[rpl]] == -999)],
